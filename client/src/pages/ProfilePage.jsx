...
const ProfilePage = () => {
  ...
  return (
    <div className='min-h-screen bg-cover bg-no-repeat flex items-center justify-center'>
      <div className='w-5/6 max-w-2xl backdrop-blur-2xl text-gray-300 border-2 flex border-gray-600 items-center justify-between max-sm:flex-col-reverse rounded-lg'>
        <form 
        ...
        className={`max-w-44 aspect-square rounde-full mx-10 max-sm:mt-10 ${selectedImg && 'rounded-full'}`}
        />
      </div>
    </div>
  )
